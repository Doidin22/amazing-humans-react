...
export default function EditarCapitulo() {
  ...
  async function handleSave() {
    if(!titulo || !conteudo) return alert("Please fill in title and content.");
    
    setSaving(true);
    try {
      await updateDoc(doc(db, "capitulos", id), {
        titulo,
        conteudo,
        ...
        <div className="animeLeft">
            ...
            <div style={{ textAlign: 'right', marginTop: 30 }}>
                <button 
                    ...
                    style={{ padding: '12px 30px', fontSize: '1rem', display: 'inline-flex', alignItems: 'center', gap: 5 }}
                >
