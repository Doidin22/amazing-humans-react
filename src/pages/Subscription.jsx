...
export default function Subscription() {
  ...
  async function handleCheckout(type, id, coinsAmount = 0) {
    ...
    try {
      ...
      console.error(error);
      // Tratamento de erro específico para a regra de autor
    ...
    <div className="max-w-6xl mx-auto px-4 py-10">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          {/* Plano Autor */}
          <div className="bg-gradient-to-b from-[#1f1f1f] to-[#2a1f2a] border border-purple-500 p-8 rounded-2xl flex flex-col relative overflow-hidden">
